...
driver.find_element(By.XPATH, "//input[@id='firstName']").send_keys('Ibrahim')
driver.find_element(By.XPATH, "//input[@id='lastName']").send_keys('Khan')
driver.find_element(By.XPATH, "//input[@id='userEmail']").send_keys('bagskaks@gmail.com')
